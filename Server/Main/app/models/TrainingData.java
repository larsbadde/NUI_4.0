 ...
 */
@Entity
public class TrainingData extends Model {
    ...
    public TrainingData (UUID SessionID, User user, Gesture gesture, Long timestamp, Device device, Boolean isRight, Float HandPosition_X, Float HandPosition_Y, Float HandPosition_Z,
